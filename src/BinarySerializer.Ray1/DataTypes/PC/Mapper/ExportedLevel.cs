namespace BinarySerializer.Ray1.PC
{
    ...
    /// </summary>
    public class ExportedLevel : BinarySerializable
    {
        #region Header
        ...
        /// The map data
        /// </summary>
        public UniversalMap MapData { get; set; }

        public MapEvents EventMevData { get; set; }
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            MapData = s.SerializeObject<UniversalMap>(MapData, name: nameof(MapData));
            EventMevData = s.SerializeObject<MapEvents>(EventMevData, name: nameof(EventMevData));
