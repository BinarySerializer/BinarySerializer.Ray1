    ...
    public class PC_FileArchive : PC_BaseFile
    {
        ...
        public void RepackArchive(Context context, Dictionary<string, Action<SerializerObject>> fileWriter)
        {
            ...
            s.DoAt(Offset, () =>
            {
                ...
                // Write end file
                s.SerializeObject<PC_FileArchiveEntry>(new PC_FileArchiveEntry
                {
                    FileName = "ENDFILE"
                }, name: "ENDFILE");
            });
        ...
        public override void SerializeImpl(SerializerObject s)
        {
                ...
                settings.EngineVersion == Ray1EngineVersion.PocketPC)
            {
                ...
                var headerBytes = PC_ArchiveHeaderTables.GetHeader(settings, Path.GetFileName(Offset.File.FilePath));
