namespace BinarySerializer.Ray1.PC
{
    ...
    /// </summary>
    public class TileTextureBlock : BinarySerializable
    {
        /// <summary>
        ...
        /// </summary>
        public TileTexture[] NonTransparentTextures { get; set; }

        /// <summary>
        /// The textures which have transparency
        /// </summary>
        public TransparentTileTexture[] TransparentTextures { get; set; }
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            s.DoProcessed(allUsesChecksum ? new Checksum8Processor() : null, p1 =>
            {
                ...
                s.DoProcessed(texturesUsesChecksum ? new Checksum8Processor() : null, p2 =>
                {
                    ...
                    NonTransparentTextures = s.SerializeObjectArray<TileTexture>(NonTransparentTextures, NonTransparentTexturesCount, name: nameof(NonTransparentTextures));
                    TransparentTextures = s.SerializeObjectArray<TransparentTileTexture>(TransparentTextures, TexturesCount - NonTransparentTexturesCount, name: nameof(TransparentTextures));
