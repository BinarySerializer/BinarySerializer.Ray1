...
namespace BinarySerializer.Ray1
{
    ...
    public enum ObjTypeFlags
    {
        ...
        IsBalle = 1 << 1, // Indicates if the object is TYPE_BALLE1 or TYPE_BALLE2
        NoCollision = 1 << 2, // Indicates if the object has no collision - does not include follow
        HurtsRayman = 1 << 3, // Indicates if the object damages Rayman
        Flag_04 = 1 << 4,
        ...
        Flag_08 = 1 << 8,
        IsCollectible = 1 << 9, // Indicates if the object can be collected and thus not respawn again
        Flag_0A = 1 << 10,
        Flag_0B = 1 << 11,
        ...
        DoCmds = 1 << 15, // Indicates if commands should be read for the object, otherwise the command is set to 30 (NOP)
