...
namespace BinarySerializer.Ray1
{
    ...
    /// </summary>
    public class Ray1TextParser : IDisposable
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        ...
        public Ray1TextParser(Ray1Settings settings, Stream stream, Encoding encoding = null)
        {
            GameSettings = settings;
            Stream = stream;
            Encoding = encoding ?? Ray1Settings.DefaultEncoding;
        }

        public Ray1Settings GameSettings { get; }
        ...
        public string ReadValue(bool readAsString = false, Encoding encoding = null)
        {
            ...
            while (true)
            {
                ...
                if (GameSettings.PCVersion == Ray1PCVersion.Android || 
                    GameSettings.PCVersion == Ray1PCVersion.iOS)
                {
                    if (b == 0x3B)
                        break;
                }
